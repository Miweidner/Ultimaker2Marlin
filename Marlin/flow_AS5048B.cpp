...
//    MSerial.println(sd[n].sensor_address, HEX);
    ...
    i2cDriverCommandSetup(sd[n].i2c_flow_write_hi_command, sd[n].sensor_address << 1  | i2cWriteBit, 100, sd[n].i2c_flow_write_hi_buffer, sizeof(sd[n].i2c_flow_write_hi_buffer));
    i2cDriverCommandSetup(sd[n].i2c_flow_write_lo_command, sd[n].sensor_address << 1  | i2cWriteBit, 100, sd[n].i2c_flow_write_lo_buffer, sizeof(sd[n].i2c_flow_write_lo_buffer));
    i2cDriverCommandSetup(sd[n].i2c_flow_read_hi_command, sd[n].sensor_address << 1 | i2cReadBit, 100, sd[n].i2c_flow_read_hi_buffer, sizeof(sd[n].i2c_flow_read_hi_buffer));
    i2cDriverCommandSetup(sd[n].i2c_flow_read_lo_command, sd[n].sensor_address << 1 | i2cReadBit, 100, sd[n].i2c_flow_read_lo_buffer, sizeof(sd[n].i2c_flow_read_lo_buffer));

    i2cDriverCommandSetup(i2c_flow_init_command, sd[n].sensor_address << 1 | i2cWriteBit, 1, i2c_flow_init_buffer, sizeof(i2c_flow_init_buffer));
